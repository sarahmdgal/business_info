...
INSERT INTO `clientinfo` (`PersonID`, `salut`, `firstname`, `mid_init`, `lastname`, `suffix`, `title`, `company_name`, `department`, `address1`, `address2`, `suite_no`, `city`, `state`, `postal_code`, `zip_code`, `mobile_phone`, `office_phone`, `home_phone`, `fax_phone`, `office_email`, `home_email`, `gender`, `age`, `notes`) VALUES
